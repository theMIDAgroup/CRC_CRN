...
x_eq_phys = nlpc_phys(1).x; %risultato fisiologico
...
for id = 1:numel(init_drug_all)
    ...
    rate_constants_mut_drug = padarray(rate_constants_mut,[2 0],0,'post');
    ...
    rate_constants_combo = rate_constants_phys; rate_constants_combo([idx_k1 idx_k2]) = [k1_drug k2_drug];
    ...
    clearvars -except max_counter x_eq_mut_drug target_folder id idx_basic_species_drug...
        folder_results perc mut_prot perc_all init_drug_all k1_drug k2_drug...
        idx_k1 idx_k2 idx_d CMIM_drug ris_phys x_eq_phys rate_constants_phys ...
        x_eq_mut perc_clt rate_constants_mut target_prot drug n_new_species
